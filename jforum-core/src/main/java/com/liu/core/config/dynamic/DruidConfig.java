...
public class DruidConfig {
    @Bean
    @ConfigurationProperties(prefix = "spring.datasource.druid.master", ignoreUnknownFields = true)
    public javax.sql.DataSource masterDataSource() {
        return getDataSource(DruidDataSourceBuilder.create().build());
    }
...
//    @ConditionalOnProperty(prefix = "spring.datasource.druid.slave", name = "enabled", havingValue = "true")
    ...
    public DynamicDataSource dataSource(
            @Qualifier("masterDataSource") javax.sql.DataSource masterDataSource,
