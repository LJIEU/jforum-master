...
import com.liu.system.converter.TestTwoConverter;
import com.liu.system.dao.TestTwo;
import com.liu.system.service.TestTwoService;
...
public class TestTwoController extends BaseController {
    ...
    @Parameters({
            ...
            @Parameter(name = "testtwo" , description = "实体参数")
    })
    @GetMapping("/list")
